...
class ResConfigSettings(models.TransientModel):
    ...
    dz23_ai_model = fields.Char(
        "Modelo", help="Ex.: llama3.1 (Ollama), llama-3.3-70b-versatile (Groq), gpt-4o-mini…",
    ...
    dz23_ai_google_key = fields.Char("Google (Gemini) API key", config_parameter="dz23.ai.google_key")
    dz23_ai_openai_key = fields.Char("OpenAI API key", config_parameter="dz23.ai.openai_key")
    dz23_ai_anthropic_key = fields.Char("Anthropic API key", config_parameter="dz23.ai.anthropic_key")
